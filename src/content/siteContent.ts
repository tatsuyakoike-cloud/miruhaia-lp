export const siteContent = {
  ...
  pricing: {
    ...
    cta: "自社に合うプランを相談する",
    performanceCta: "成果報酬プランを相談する",
    addonsTitle: "必要な施策だけ、後から追加できます。",
    addons: ["追加撮影", "他媒体への展開", "広告運用", "採用LP", "内製化支援"],
    plans: [
      {
        id: "ai",
        name: "AI動画プラン",
        features: ["初回のみ現場の素材を撮影", "実写素材とAIを組み合わせて動画化", "撮影負担を抑えて始めたい企業向け"],
      },
      {
        id: "hybrid",
        name: "ハイブリッドプラン",
        features: ["単発または3か月に1回の撮影", "実写とAI動画をバランスよく活用", "素材の鮮度と撮影負担を両立"],
      },
      {
        id: "regular",
        name: "企業PRプラン",
        featured: true,
        features: ["2か月に1回、現場の「今」を撮影", "実写素材とAIを組み合わせて継続発信", "人・仕事・文化を企業のPR資産として蓄積"],
      },
    ],
  },
  process: {
